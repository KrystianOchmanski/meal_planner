...
final initialProducts = [
  ProductsCompanion(name: Value('Ziemniaki'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Pomidor'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Ogórek'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Marchew'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Cebula'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Czosnek'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Papryka'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Brokuł'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Kalafior'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Szpinak'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Sałata'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Kapusta'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Dynia'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Bakłażan'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Cukinia'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Rzodkiewka'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Por'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Burak'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Banany'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Jabłka'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Pomarańcze'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Cytryny'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Truskawki'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Gruszki'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Winogrona'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Brzoskwinie'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Morele'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Śliwki'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Maliny'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Jagody'), category: Value('Warzywa i owoce'), unit: Value('g')),
  ProductsCompanion(name: Value('Ananas'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Mango'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Arbuz'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Melon'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Kiwi'), category: Value('Warzywa i owoce'), unit: Value('szt')),
  ProductsCompanion(name: Value('Mleko'), category: Value('Nabiał'), unit: Value('szt')),
  ProductsCompanion(name: Value('Jajka'), category: Value('Nabiał'), unit: Value('szt')),
